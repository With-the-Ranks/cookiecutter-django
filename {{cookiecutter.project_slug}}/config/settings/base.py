...
APPS_DIR = ROOT_DIR / "{{ cookiecutter.project_slug }}/core"
env = environ.Env()
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "{{ cookiecutter.project_slug }}.core.utils.context_processors.settings_context",
...
WAGTAIL_SITE_NAME = '{{ cookiecutter.description }}'
